...
import g.xdroidrequest.delivered.DeliveryImpl;
import g.xdroidrequest.delivered.IDelivery;
import g.xdroidrequest.dispatcher.CacheDispatcher;
import g.xdroidrequest.dispatcher.NetworkDispatcher;
import g.xdroidrequest.network.HttpStack;
import g.xdroidrequest.network.HurlStack;
import g.xdroidrequest.network.Network;
...
public class RequestQueue {
     ...
     * {@link g.xdroidrequest.queue.RequestQueue#cancelAll(g.xdroidrequest.queue.RequestQueue.RequestFilter)}.
     */
